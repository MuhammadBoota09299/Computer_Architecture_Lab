...
# this entry is to align reset_handler at address 0x04
  ...
  .align 6
vtable:
  j        mexc_handler    # Added exception handler
  .word 0
  .word 0
  j        msip_handler
  .word 0
...
# Placeholder for machine exception handler
.global mexc_handler
.type mexc_handler, @function

mexc_handler:
    # Simple infinite loop for now, can replace with actual logic
    j mexc_handler
